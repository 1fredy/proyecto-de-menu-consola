...
using static proyecto_de_menu_consola.Ejemplo_if;
using static proyecto_de_menu_consola.Ejemplo_switch;
using static proyecto_de_menu_consola.Ejemplo_for;
using static proyecto_de_menu_consola.Ejemplo_while;
using static proyecto_de_menu_consola.Ejemplo_dowhile;

namespace proyecto_de_menu_consola
{
    class principal
    {
